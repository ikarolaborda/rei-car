...
(1, 'OS-2026-0001', 1, 'MECHANIC', 45230, NULL, 350.00, 'FINISHED', DATE_SUB(CURDATE(), INTERVAL 30 DAY)),
(2, 'OS-2026-0002', 2, 'TIRE_SHOP', NULL, 'Dianteiro Esquerdo', 80.00, 'FINISHED', DATE_SUB(CURDATE(), INTERVAL 28 DAY)),
(3, 'OS-2026-0003', 3, 'MECHANIC', 78500, NULL, 1200.00, 'FINISHED', DATE_SUB(CURDATE(), INTERVAL 25 DAY)),
(4, 'OS-2026-0004', 4, 'TIRE_SHOP', NULL, 'Traseiro Direito', 120.00, 'FINISHED', DATE_SUB(CURDATE(), INTERVAL 20 DAY)),
(5, 'OS-2026-0005', 5, 'MECHANIC', 32100, NULL, 580.00, 'FINISHED', DATE_SUB(CURDATE(), INTERVAL 15 DAY)),
(6, 'OS-2026-0006', 1, 'MECHANIC', 45890, NULL, 450.00, 'FINISHED', DATE_SUB(CURDATE(), INTERVAL 10 DAY)),
(7, 'OS-2026-0007', 6, 'TIRE_SHOP', NULL, 'Dianteiro Direito', 150.00, 'FINISHED', DATE_SUB(CURDATE(), INTERVAL 7 DAY)),
(8, 'OS-2026-0008', 7, 'MECHANIC', 89200, NULL, 2500.00, 'FINISHED', DATE_SUB(CURDATE(), INTERVAL 5 DAY)),
